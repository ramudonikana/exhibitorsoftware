 ...
 */
public class ExcelFie2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			rowhead.createCell((short) 1).setCellValue("Movie Name");
			...
			FileOutputStream fileOut = new FileOutputStream("F:\\"+request.getParameter("theator")+"Theatre Monthly Report"+randomInt+".xls");
			wb.write(fileOut);
			try{
			  ...
			  // -- Set the FROM and TO fields --
			     ...
			     DataSource source =  new FileDataSource("F:\\"+request.getParameter("theator")+"Theatre Monthly Report"+randomInt+".xls"); // your file
			     msg.setDataHandler( new DataHandler(source));
			     msg.setFileName("F:\\"+request.getParameter("theator")+"Theatre Monthly Report"+randomInt+".xls");
