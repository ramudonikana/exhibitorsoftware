...
{
var x=document.forms["editTerm"]["percentage"].value;
var y=document.forms["editTerm"]["mg"].value;
var z=document.forms["editTerm"]["advance"].value;
var a = /^[a-zA-Z0-9\s]+$/; 
...
{  
alert("enter percentage numbers only");   
return false;
}  
else if(z==null || z=="" )
{
...
{  
alert("enter advance numbers only");   
return false;
}  
else if(y==null || y=="")
  {
  alert("enter marginProfit ");   
  return false;
  }
else if(y.match(a))  
{  
alert("enter marginprofit numbers only");   
return false;
}  
...
%>
<%
UpdateTermDAO dao = new UpdateTermDAO();
%>
<form method="POST" action='UpdateTermHandler' name="editTerm">
<input type="hidden" name="action" value="updateTerm" /> <%
String uid = request.getParameter("termId");
if (!((uid) == null)) {
int id = Integer.parseInt(uid);
state = dao.getStateByTermId(id);
%>
<h1 align="center">Term Details</h1>
<table align="center">
<tr>
<td>Term ID</td>
<td><input type="text" name="termid" readonly="readonly"
value="<%=state.getTermId()%>"></td>
</tr>
<tr>
<td>Percentage</td>
<td><input type="text" name="percentage" value="<%=state.getPercentage()%>"/></td>
</tr>
<tr>
<td>advance</td>
<td><input type="text" name="advance" value="<%=state.getAdvance()%>"/></td>
</tr>
<tr>
<td>marginprofit</td>
<td><input type="text" name="mg" value="<%=state.getMarginProfit()%>"/></td>
</tr>
<tr>
<td></td>
<td><input type="submit" value="Update" onclick="return termValidateForm()"/></td>
