<!DOCTYPE html>
<%@page import="com.bvr.dao.UpdateDistributorDAO"%>
<%@page import="com.bvr.bean.DistributorBean"%>
...
{
var x=document.forms["editdist"]["distributorName"].value;
var y=document.forms["editdist"]["mobileNumber"].value;
var z=document.forms["editdist"]["address"].value;
var a = /^[a-zA-Z0-9\s]+$/; 
...
%>
<%
UpdateDistributorDAO dao = new UpdateDistributorDAO();
%>
<form method="POST" action='UpdateDistributorHandler' name="editdist">
<input type="hidden" name="action" value="updatedist" /> <%
String uid = request.getParameter("distributorId");
if (!((uid) == null)) {
int id = Integer.parseInt(uid);
state = dao.getStateBydistributorId(id);
%>
<h1 align="center">Distributor Details</h1>
<table align="center">
<tr>
<td>DistributorID</td>
<td><input type="text" name="distid" readonly="readonly"
value="<%=state.getDistributorId()%>"></td>
</tr>
<tr>
<td>DistributorNAme</td>
<td><input type="text" name="distname" value="<%=state.getDistributorName()%>"/></td>
</tr>
<tr>
<td>Distributor mobileno</td>
<td><input type="text" name="distmobileno" value="<%=state.getMobileNumber()%>"/></td>
</tr>
<tr>
<td>Address</td>
<td><input type="text" name="distaddress" value="<%=state.getAddress()%>"/></td>
</tr>
<tr>
<td></td>
<td><input type="submit" value="Update" onclick="return distributorValidateForm()" /></td>
