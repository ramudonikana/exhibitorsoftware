<!DOCTYPE html>
<%@page import="com.bvr.dao.UpdateDistrictDAO"%>
<%@page import="com.bvr.bean.DistrictBean"%>
...
<head>
<script>
	function districtValidateForm() {
		var y = document.forms["editDistrict"]["districtName"].value;
		var a = /^[a-zA-Z0-9\s]+$/;
		if (y == null || y == "") {
...
div.buttons:hover {
	...
	background-image: -webkit-linear-gradient(bottom, rgba(0, 0, 0, 0),
		rgba(0, 0, 0, 0.4) );
	background-image: -moz-linear-gradient(bottom, rgba(0, 0, 0, 0),
		rgba(0, 0, 0, 0.4) );
	background-image: -o-linear-gradient(bottom, rgba(0, 0, 0, 0),
		rgba(0, 0, 0, 0.4) );
	background-image: -ms-linear-gradient(bottom, rgba(0, 0, 0, 0),
		rgba(0, 0, 0, 0.4) );
	background-image: linear-gradient(bottom, rgba(0, 0, 0, 0),
		rgba(0, 0, 0, 0.4) );
}
...
<body>
		...
		<form action="#" method="get()">
			<div class="dropdownwrap">
				<select class="e1" name="State">
					...
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <select class="e1" name="district">
					<option>Select District</option>
					<option>abcd</option>
					<option>acbd</option>
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <select class="e1" name="city">
					<option>Select City</option>
					<option>abcd</option>
					<option>acbd</option>
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <select class="e1" name="center">
					<option>Select Center</option>
					<option>abcd</option>
					<option>acbd</option>
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <select class="e1" name="theater">
					<option>Select Theater</option>
					<option>abcd</option>
					<option>acbd</option>
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <select class="e1" name="movie_name">
					<option>Select Movie</option>
					<option>abcd</option>
					<option>acbd</option>
					<option>adcb</option>
					<option>adbc</option>
				</select><br> <input type="submit" value="submit"> <input
	...
	<div class=buttons>
		<a id="dropdown1" href="#"><img
			src="./Images/collection_button.png" height="100" width="150">
		</a></a>
	</div>
	<div class=buttons>
		<a id="dropdown2" href="#"><img src="./Images/report_button1.jpg"
			height="100" width="150">
		</a></a>
	</div>
	<div class=buttons>
		<a id="dropdown3" href="#"><img src="./Images/button1.jpg"
			height="100" width="150">
		</a></a>
	</div>
	...
	<div id="display_details">
		...
		%>
		<%
			UpdateDistrictDAO dao = new UpdateDistrictDAO();
		%>
		<form method="POST" action='UpdateDistrictHandler' name="editDistrict">
			<input type="hidden" name="action" value="updateDistrict" />
			<%
				String uid = request.getParameter("districtId");
				if (!((uid) == null)) {
					int id = Integer.parseInt(uid);
					district = dao.getDistrictBydistrictId(id);
			%>
			<h1 align="center">District Details</h1>
			<table align="center">
				<tr>
					<td>district ID</td>
					<td><input type="text" name="districtId" readonly="readonly"
				...
				<tr>
					...
					<td><a href="Distributor.jsp"><input type="button"
							value="cancel">
					</a>
					</td>
				</tr>
	...
	<div id=footer>
		...
		<a href="Aboutus.jsp" class="foot" style="text-decoration: none;">About
			Us</a> <a href="Contactus.jsp" class="foot"
