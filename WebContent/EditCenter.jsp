<!DOCTYPE html>
<%@page import="com.bvr.dao.UpdateCenterDAO"%>
<%@page import="com.bvr.bean.CenterBean"%>
...
<head>
<script>
function centerValidateForm()
{
	var a = /^[a-zA-Z0-9\s]+$/; 
var y=document.forms["editCenter"]["centerName"].value;
if ( y==null || y=="" )
  {
...
%>
<%
UpdateCenterDAO dao = new UpdateCenterDAO();
%>
<form method="POST" action='UpdateCenterHandler' name="editCenter">
<input type="hidden" name="action" value="updateCenter" /> <%
String uid = request.getParameter("centerId");
if (!((uid) == null)) {
int id = Integer.parseInt(uid);
center = dao.getCenterBycenterId(id);
%>
<h1 align="center">Centre Details</h1>
<table align="center">
<tr>
<td>center ID</td>
<td><input type="text" name="centerId" readonly="readonly"
value="<%=center.getCenterId()%>"></td>
</tr>
<tr>
<td>District Id</td>
<td><input type="text" name="districtId" readonly="readonly" value="<%=center.getDistrictId()%>"/></td>
</tr>
<tr>
<td>center Name</td>
<td><input type="text" name="centerName" value="<%=center.getCenterName()%>"/></td>
</tr>
<tr>
<td></td>
<td><a href="allinone2.jsp"><input type="submit" value="Update" onclick="return centerValidateForm()"></a></td>
