<!DOCTYPE html>
<%@page import="com.bvr.dao.UpdateAllMovieDAO"%>
<%@page import="com.bvr.bean.MoviesBean"%>
...
{
	var a = /^[a-zA-Z0-9\s]+$/; 
var y=document.forms["editMovie"]["mname"].value;
if ( y==null || y=="" )
  {
...
%>
<%
UpdateAllMovieDAO dao = new UpdateAllMovieDAO();
%>
<form method="POST" action='UpdateAllMovieHandler' name="editMovie">
<input type="hidden" name="action" value="update" /> <%
String uid = request.getParameter("movieId");
if (!((uid) == null)) {
int id = Integer.parseInt(uid);
state = dao.getStateByMovieId(id);
%>
...
<tr>
<td></td>
<td><input type="submit" value="Update" onclick="return movieValidateForm()" /></td>
