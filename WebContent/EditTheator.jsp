...
<head>
<script>
function theatorValidateForm()
{
var b=document.forms["editTheator"]["theatorName"].value;
var c=document.forms["editTheator"]["showTax"].value;
var d=document.forms["editTheator"]["rent"].value;
var e=document.forms["editTheator"]["batta"].value;
var f=document.forms["editTheator"]["slab"].value;
var g=document.forms["editTheator"]["ownerName"].value;
var h=document.forms["editTheator"]["contactNumber"].value;
var i=document.forms["editTheator"]["distributorShare"].value;
var j=document.forms["editTheator"]["exhibitorShare"].value;
var a= /^\d{10}$/; 
var k = /^[a-zA-Z0-9\s]+$/; 
...
{  
alert("enter theator name alphabets only");   
return false;
}  
else if( c==null || c=="")
{
alert("enter showtax field");
 return false;
}
else if(c.match(k))  
{  
alert("enter showtax numbers only");   
return false;
}  
else if( d==null || d=="")
{
alert("enter rent field");
 return false;
}
else if(d.match(k))  
{  
alert("enter rent numbers only");   
return false;
}
else if( e==null || e=="")
{
alert("enter batta field");
 return false;
}
else if(e.match(k))  
{  
alert("enter batta numbers only");   
return false;
} 
else if( f==null || f=="")
{
alert("enter slab field");
 return false;
}
else if(f.match(k)) 
{  
alert("enter slab numbers only");   
return false;
} 
else if(g==null || g=="")
{
...
{  
alert("enter owner name alphabets only");   
return false;
}
else if(h==null || h=="" )
{
...
{  
alert("enter distributor share numbers only");   
return false;
}
else if(j==null || j=="")
{
alert("enter exhibitor share");
 return false;
}
else if(j.match(k)) 
{  
alert("enter exhibitor share numbers only");   
return false;
}  
  return true;
}
...
%>
<%
UpdateTheatorDAO dao = new UpdateTheatorDAO();
%>
<form method="POST" action='UpdateTheatorHandler' name="editTheator">
<input type="hidden" name="action" value="updateTheator" /> <%
String uid = request.getParameter("theatorId");
if (!((uid) == null)) {
int id = Integer.parseInt(uid);
theator = dao.getTheatorBytheatorId(id);
%>
<h1 align="center">Theatre Details</h1>
<table align="center">
<tr>
<td>theator ID</td>
<td><input type="text" name="theatorId" readonly="readonly"
value="<%=theator.getTheatorId()%>"></td>
</tr>
<tr>
<td>CenterId</td>
<td><input type="text" name="centerId" readonly="readonly" value="<%=theator.getCenterName()%>"/></td>
</tr>
<tr>
<td>TheatorName</td>
<td><input type="text" name="theatorName" value="<%=theator.getTheatorName()%>"/></td>
</tr>
<tr>
<td>HousefulCapacity</td>
<td><input type="text" name="housefulCapacity" value="<%=theator.getHousefulCapacity()%>"/></td>
</tr>
<tr>
<td>TheatorDescription</td>
<td><input type="text" name="theatreDescription" value="<%=theator.getTheatreDescription()%>"/></td>
</tr>
<tr>
<td>OwnerName</td>
<td><input type="text" name="ownerName" value="<%=theator.getOwnerName()%>"/></td>
</tr>
<tr>
<td>ContactNumber</td>
<td><input type="text" name="contactNumber" onkeyup="isNumberKey(event)" value="<%=theator.getContactNumber()%>"/></td>
</tr>
<tr>
<td>TheatreTent</td>
<td><input type="text" name="theatreRent" value="<%=theator.getTheatreRent()%>"/></td>
</tr>
<tr>
<td>DistributorShare</td>
<td><input type="text" name="distributorShare" value="<%=theator.getDistributorShare()%>"/></td>
</tr>
<tr>
<td>slab</td>
<td><input type="text" name="slab" value="<%=theator.getSlab()%>"></td>
</tr>
<tr>
<td>ShowTax</td>
<td><input type="text" name="showTax" value="<%=theator.getShowTax()%>"/></td>
</tr>
<tr>
<td>Batta</td>
<td><input type="text" name="batta" value="<%=theator.getBatta()%>"/></td>
</tr>
<tr>
<td>Inr</td>
<td><input type="text" name="inr" value="<%=theator.getInr()%>"></td>
</tr>
<tr>
<td>Mc</td>
<td><input type="text" name="mc" value="<%=theator.getMc()%>"></td>
</tr>
...
<tr>
<td></td>
<td><input type="submit" value="Update" onclick="return theatorValidateForm()" /></td>
