...
<!--Footer begins-->
 ...
 String[] ss = bb.split(",");
/* String bb1=request.getParameter("bb1");
String bb2=request.getParameter("bb2");
System.out.println("bb value:"+bb);
 */ PreparedStatement pstmt;
 ResultSet rs;
 pstmt = c1.prepareStatement("Select * from collection  WHERE da BETWEEN ? AND ? && tname=?"); 
